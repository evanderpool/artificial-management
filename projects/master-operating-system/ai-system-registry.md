...
|---|---|---|---|---|---|---|
| chief-of-staff | Chief of Staff Agent | Reads all project READMEs (dynamic), logs, and priorities and produces a daily brief — saved to file and displayed in chat | Active | `.claude/skills/chief-of-staff/SKILL.md` | Erick | 2026-05-14 |
| project-manager | Project Manager Agent | Produces sprint plans, status checks, and blocker reviews across all registered projects — 3 modes (sprint/status/blockers) | Active | `.claude/skills/project-manager/SKILL.md` | Chief of Staff Agent, Erick | 2026-05-14 |
